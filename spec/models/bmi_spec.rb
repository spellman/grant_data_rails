...
describe Bmi do
  ...
  it "requires a valid patient" do
    valid_patient   = Bmi.new patient_id: @valid_patient.id, bmi: @valid_bmi, date: @valid_date
    no_patient      = Bmi.new                                bmi: @valid_bmi, date: @valid_date
    invalid_patient = Bmi.new patient_id: -1,                bmi: @valid_bmi, date: @valid_date
  ...
  it "requires a valid date" do
    valid_date   = @valid_patient.bmis.build bmi: @valid_bmi, date: Time.zone.local(2013, 1, 1)
    no_date      = @valid_patient.bmis.build bmi: @valid_bmi
    invalid_date = @valid_patient.bmis.build bmi: @valid_bmi, date: "foo"
