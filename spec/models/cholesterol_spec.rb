...
describe Cholesterol do
  ...
  it "requires a valid patient" do
    valid_patient   = Cholesterol.new patient_id: @valid_patient.id, tc: @valid_tc, date: @valid_date
    no_patient      = Cholesterol.new                                tc: @valid_tc, date: @valid_date
    invalid_patient = Cholesterol.new patient_id: -1,                tc: @valid_tc, date: @valid_date
  ...
  it "requires a valid date" do
    valid_date   = @valid_patient.cholesterols.build tc: @valid_tc, date: Time.zone.local(2013, 1, 1)
    no_date      = @valid_patient.cholesterols.build tc: @valid_tc
    invalid_date = @valid_patient.cholesterols.build tc: @valid_tc, date: "foo"
  ...
  it "requires at least one of tc, tg, hdl, ldl" do
    valid_values      = @valid_patient.cholesterols.build tc: @valid_tc, date: @valid_date
    all_values        = @valid_patient.cholesterols.build tc:   @valid_tc,
                                                          tg:   @valid_tg,
                                                          hdl:  @valid_hdl,
                                                          ldl:  @valid_ldl,
                                                          date: @valid_date
    no_values         = @valid_patient.cholesterols.build                 date: @valid_date
    negative_value    = @valid_patient.cholesterols.build hdl: -1,        date: @valid_date
    non_integer_value = @valid_patient.cholesterols.build ldl:  1.5,      date: @valid_date
